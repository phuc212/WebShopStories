...
namespace StoryFIN3Demo.App_Start
{
    public class ApplicationUserManager : UserManager<Account>
    {
        ...
        {
            var manager = new ApplicationUserManager(new UserStore<Account>(context.Get<DemoFIN3Context>()));
    ...
    public class ApplicationRoleManager : RoleManager<IdentityRole>
    {
        ...
        {
            return new ApplicationRoleManager(new RoleStore<IdentityRole>(context.Get<DemoFIN3Context>()));
        }
    }
